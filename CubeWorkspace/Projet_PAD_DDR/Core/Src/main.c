...
/* USER CODE BEGIN PV */
extern USBD_HandleTypeDef hUsbDeviceFS; // On récupère le handle USB défini ailleurs
uint8_t mouseReport[4] = {0, 0, 0, 0};  // Le tampon pour envoyer les données au PC
/* USER CODE END PV */
